# rctest
# Autogenerated from man page /usr/lib/jvm/default/man/man1/rctest.1.gz
complete -c rctest -s b -d 'send/receive bytes bytes'
...
complete -c rctest -s M -d 'become master'
