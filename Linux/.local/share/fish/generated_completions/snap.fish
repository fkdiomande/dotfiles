# snap
# Autogenerated from man page /usr/lib/jvm/default/man/man8/snap.8.gz
...
complete -c snap -l required -d 'Ensure that given backend:feature is available debug state Inspect a snapd st…'
...
complete -c snap -l ignore-validation -d 'Ignore validation by other snaps blocking the refresh remove Remove snaps fro…'
