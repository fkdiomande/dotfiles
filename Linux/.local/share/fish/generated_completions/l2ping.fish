# l2ping
# Autogenerated from man page /usr/lib/jvm/default/man/man1/l2ping.1.gz
complete -c l2ping -s i -d 'The command is applied to device  hciX , which must be the name of an install…'
