# debuginfod
# Autogenerated from man page /usr/lib/jvm/default/man/man8/debuginfod.8.gz
...
complete -c debuginfod -l fdcache-fds -l fdcache-mbs -l fdcache-prefetch -d 'Configure limits on a cache that keeps recently extracted files from archives'
complete -c debuginfod -l fdcache-mintmp -d 'Configure a disk space threshold for emergency flushing of the cache'
