# systemd-nspawn
# Autogenerated from man page /usr/lib/jvm/default/man/man1/systemd-nspawn.1.gz
...
complete -c systemd-nspawn -l private-users-chown -d 'If specified, all files and directories in the container\\*(Aqs directory tree…'
