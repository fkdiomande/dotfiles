...
complete -c coredumpctl -l no-legend -d 'Do not print column headers'
complete -c coredumpctl -l no-pager -d 'Do not pipe output into a pager'
complete -c coredumpctl -s 1 -d 'Show information of a single core dump only, instead of listing all known cor…'
